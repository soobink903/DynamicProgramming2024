...
Part 1: neoclassical growth model --- planning problem
\begin{enumerate}
	\item Environment
...
\vspace{5mm}
Part 3: neoclassical growth model --- competitive equilibrium
\begin{enumerate}
	\item Environment
...
\begin{transitionframe}
	{\color{white} \Huge \textbf{Part 2: planning problem} \vspace{2mm}}
\end{transitionframe}
...
\begin{frame}{}
\begin{witemize}
\item Recall: social planner chooses an allocation to maximize welfare subject only to technology and resource constraints
...
%%%%%%%%%%%%%%%%%%%%%%%%%%  SLIDE   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{transitionframe}
	{\color{white} \Huge \textbf{Part 3: dynamic programming} \vspace{2mm}}
\end{transitionframe}
...
\item If $V(k)$ solves the above equation, then it is a solution to the Bellman equation. We now show that the unique value function that solves the sequence problem also solves the Bellman equation
...
%%%%%%%%%%%%%%%%%%%%%%%%%%  SLIDE   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{transitionframe}
	{\color{white} \Huge \textbf{Part 4: competitive equilibrium} \vspace{2mm}}
\end{transitionframe}
